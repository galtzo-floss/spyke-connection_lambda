# kettle-jem:freeze
# To retain chunks of comments & code during spyke-connection_lambda templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# spyke-connection_lambda will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
