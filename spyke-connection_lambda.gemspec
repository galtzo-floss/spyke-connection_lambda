...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/spyke/connection_lambda/version.rb", mod) }::Spyke::ConnectionLambda::Version::VERSION
  else
    require_relative "lib/spyke/connection_lambda/version"
    Spyke::ConnectionLambda::Version::VERSION
  end
...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/galtzo-floss/spyke-connection_lambda"
  spec.licenses = ["MIT"]
  ...
  spec.metadata["homepage_uri"] = "https://github.com/pboling/spyke-connection_lambda"
  ...
  package_metadata_files = %w[
    ...
    LICENSE.md
    README.md
    sig/spyke/connection_lambda.rbs
